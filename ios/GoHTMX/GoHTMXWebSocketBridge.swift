...
public class GoHTMXWebSocketBridge: NSObject {
    ...
    public func connect(url: String) throws -> String {
        ...
        guard let sessionID = sessionID, !sessionID.isEmpty else {
            throw GoHTMXError.bridgeNotInitialized
        }
...
// MARK: - GohtmxWebSocketCallbackProtocol
extension GoHTMXWebSocketBridge: GohtmxWebSocketCallbackProtocol {
    ...
    public func onError(_ sessionID: String?, error: String?) {
        ...
        let js = "window._gohtmx_ws_error('\(sessionID)', '\(errorEscaped)')"
